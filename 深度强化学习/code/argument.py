def dqn_arguments(parser):
    ...
    parser.add_argument("--n_frames", default=int(500), type=int)
...
def pg_arguments(parser):
    ...
    parser.add_argument("--gamma", default=0.99, type=float)
    parser.add_argument("--grad_norm_clip", default=0.01, type=float)

    parser.add_argument("--test", default=False, type=bool)
    parser.add_argument("--use_cuda", default=True, type=bool)
    parser.add_argument("--n_frames", default=int(8000), type=int)
